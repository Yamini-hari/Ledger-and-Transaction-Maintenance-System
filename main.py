...
def add_menu(window):
    ...
    about_menu.add_command(label="Yamini Hari",
                           command=lambda: web.open("https://www.linkedin.com/in/yamini-hari-449209191/"))
    about_menu.add_command(label="Varuni H Kulkarni",
                           command=lambda: web.open("https://www.linkedin.com/in/varuni-kulkarni-436124233/"))
